...
This chapter reports empirical outcomes under the protocol defined in Chapter \ref{chapter:experimental-design}. Scenario~1 is reported with full numerical evidence, while Scenario~2 retains the same reporting structure as placeholders for later insertion.
